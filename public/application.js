...
var onCreateBriefs = function onCreateBriefs(event) {
  event.preventDefault();
  // pass event.target to getFormFields to create a data object
  var data = getFormFields(event.target);

  // pass data to createTrips function
  api.createBriefs(data).then(ui.createBriefSuccess).catch(ui.createBriefFailure);
};

var onGetBriefs = function onGetBriefs(event) {
  event.preventDefault();
  api.getBriefs(event).then(ui.getBriefsSuccess).catch(ui.getBriefsFailure);
};

var onUpdateBrief = function onUpdateBrief(event) {
  event.preventDefault();
  var data = getFormFields(event.target);

  var updateId = event.target.dataset.id;
  // send data to api method
  api.updateBrief(updateId, data).then(ui.updateBriefSuccess).catch(ui.updateBriefFailure);
};

var onDeleteBrief = function onDeleteBrief(event) {
  event.preventDefault();
  // const data = getFormFields(this)
  var id = event.target.dataset.id;
  api.deleteBrief(id).then(ui.deleteBriefSuccess).catch(ui.deleteBriefFailure);
};
...
var createBriefs = function createBriefs(data) {
  return $.ajax({
...
var getBriefs = function getBriefs() {
  return $.ajax({
    url: config.apiUrl + '/briefs',
    method: 'GET',
    headers: {
...
var updateBrief = function updateBrief(updateId, data) {
  return $.ajax({
...
var deleteBrief = function deleteBrief(id) {
  return $.ajax({
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://briefs-server.herokuapp.com',
...
var store = __webpack_require__(3);
var showHandlebars = __webpack_require__(16);
...
var createBriefSuccess = function createBriefSuccess(data) {
  $('.content').empty();
  $('.update').val('');
...
var createBriefFailure = function createBriefFailure() {
  $('.update').val('');
...
var getBriefsSuccess = function getBriefsSuccess(data) {
  var showBriefsHtml = showHandlebars({ briefs: data.briefs });
  $('#content').html(showBriefsHtml);
  var elements = data.briefs;
...
var getBriefsFailure = function getBriefsFailure(data) {
  $.toast({
    text: 'Check your connection',
...
var updateBriefSuccess = function updateBriefSuccess(data) {
  $('.content').empty();
...
var updateBriefFailure = function updateBriefFailure() {
  $('.content').empty();
...
var deleteBriefSuccess = function deleteBriefSuccess() {
  $('.content').empty();
  $('#password-change-field').val('');
  $('#password-confirm-change').val('');
...
var deleteBriefFailure = function deleteBriefFailure() {
  $('.content').empty();
...
module.exports = {
  ...
  createBriefSuccess: createBriefSuccess,
  createBriefFailure: createBriefFailure,
  getBriefsSuccess: getBriefsSuccess,
  getBriefsFailure: getBriefsFailure,
  updateBriefSuccess: updateBriefSuccess,
  updateBriefFailure: updateBriefFailure,
  deleteBriefSuccess: deleteBriefSuccess,
  deleteBriefFailure: deleteBriefFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "      <!-- "
    ...
    + " </td>\n    <td> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.subject : stack1), depth0))
    + " </td>\n    <td> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.body_text : stack1), depth0))
    + " </td>\n    <td> "
    ...
    + " </td>\n\n    <!-- </div> -->\n\n    <td> <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"btn btn-default delete\">Delete Brief</button> </td>\n    <td>\n      <!-- Button trigger modal -->\n<button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"button\" class=\"btn btn-primary new-button\">\nEdit\n</button>\n      </td>\n      </tr>\n\n  </tbody>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "\n<table style=\"width:100%\" class=\"table content table-hover\">\n  <thead class=\"thead-dark\">\n    <th align=\"center\"> Brief ID </th>\n    <th align=\"center\"> Brief Title </th>\n    <th align=\"center\"> Subject </th>\n    <th align=\"center\"> Body Text </th>\n    <th align=\"center\"> Created On </th>\n    <th align=\"center\"> Updated On </th>\n\n\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.briefs : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</table>\n";
